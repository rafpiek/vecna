...
program.command('lint', 'lint files').action(() => import('./commands/lint').then(i => i.default(config, git)));
program.command('test', 'run tests').action(() => import('./commands/test').then(i => i.default(config, git)));
